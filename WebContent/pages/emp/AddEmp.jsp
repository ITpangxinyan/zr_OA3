...
<script type="text/javascript">
	$(document).ready(function(e) {
		...
		$('#deptBtn').click(function() {
			popWin.showWin("600", "500", "选择部门", "QueryDeptSmall.jsp");
		});
...
<h3>请填写新员工信息</h3>
<form name="form1" id="form1" method="post" action="saveEmployee.action">
	...
	<tbody>
		...
		<tr>
			...
			<td><input name="password" id="password" datatype="*"
				errormsg="不能为空！" type="password" value="111111"><span
				class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td>性别</td>
			<td><select name="sex">
				<option selected="selected" value="a">男</option>
		...
		<tr>
			<td>所属部门</td>
			<td><input name="departmentId" id="deptName" datatype="*"
				errormsg="不能为空！" type="text"> <input name="depId"
				id="deptId" type="hidden"> <input name="button" id="deptBtn"
				value="选择部门" class="btn btn-primary" type="submit"  ><span
				class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td>职务</td>
			<td><input name="positionId" id="jobName" datatype="*"
				errormsg="不能为空！" type="text"> <input name="posId" id="jobId"
				type="hidden"> 
				<a name="button2" id="jobBtn"
				 class="btn btn-primary" type="button" href="a.action">选择职务</a>
				<span
				class="Validform_checktip"></span></td>
		</tr>
	</tbody>
